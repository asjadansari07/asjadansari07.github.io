var cornify_count = 0,
    ...
    cornify_updatecount = function () {
        ...
        null == (e = document.getElementById(t)) && ((e = document.createElement("p")).id = t, e.style.position = "fixed", e.style.bottom = "5px", e.style.left = "0px", e.style.right = "0px", e.style.zIndex = "1000000000", e.style.color = "#ff0000", e.style.textAlign = "center", e.style.fontSize = "24px", e.style.fontFamily = "'fantasy', 'Comic Sans', 'Marker Felt', sans-serif", e.style.textTransform = "uppercase", e.style.fontWeight = "bolder", e.style.backgroundColor = "#ffffff", document.getElementsByTagName("body")[0].appendChild(e));
        e.innerHTML = 1 == cornify_count ? "You cornified!" : "You cornified " + cornify_count + " times!", cornify_setcookie("cornify", cornify_count + "", 1e3)
    },
